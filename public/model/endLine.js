class EndLine{
  ...
  render(tS){
    ...
    let strEndLine =
      ...
      <text x=${this.posX} y=${this.posY} fill="white" font-size=${G.maxH() ? '96px' : '22vh'} text-anchor="middle" dominant-baseline="central" stroke="black" stroke-width=${G.maxH() ? '4.5px' : '1vh'}>
        ${this.finalNumber}
      </text>`;
